...
DEFAULT_ITEMS: dict[str, Item] = {
    "rusted-knife": Item(
        ...
        name="Rusted Knife",
        item_type="weapon",
        description="A badly worn knife that has seen better days.",
        rarity="common",
        stackable=False,
        weight=0.8,
        value=4,
    ...
    "traveler-coat": Item(
        ...
        item_type="armor",
        description="A practical coat made for long roads and bad weather.",
        rarity="common",
        stackable=False,
        weight=2.0,
        value=12,
        stats={"defense": 4, "max_hp": 5},
        tags=["armor", "starter"],
    ),
    "health-potion": Item(
        id="health-potion",
    ...
    "old-photograph": Item(
        ...
        name="Old Photograph",
        item_type="quest",
        description="A faded photograph with a person carefully scratched out.",
        rarity="uncommon",
        stackable=False,
        weight=0.0,
        value=0,
